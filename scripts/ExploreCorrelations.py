...
outputFile = "scripts/notebook/results/correlations/{project}_correlations.csv"
...
for project in ["angular"]:
  ...
  for task in c.TASK_LIST:
    ...
    correlationsFiles = open(outputFile.format(project=project), "w")
    ...
    print('{0}:{1} - Pearsons correlation:'.format(project, task))
    print('E_Module => NT_CC: {0}'.format(corr_module_nt_cc))
    print('E_Module => NO_CC: {0}'.format(corr_module_no_cc))
    print('E_Module => T_CC: {0}'.format(corr_module_t_cc))
    print('E_Module => NT_EC: {0}'.format(corr_module_nt_ec))
    print('E_Module => NO_CC: {0}'.format(corr_module_no_ec))
    print('E_Module => T_EC: {0}'.format(corr_module_t_ec))
    print('E_Module => T_Line: {0}\n'.format(corr_module_t_line))

    correlationsFiles.write('E_Module => NT_CC: {0}'.format(corr_module_nt_cc))
    ...
    print('{0}:{1} - Pearsons correlation:'.format(project, task))
    print('E_Line => NT_CC: {0}'.format(corr_line_nt_cc))
    print('E_Line => NO_CC: {0}'.format(corr_line_no_cc))
    print('E_Line => T_CC: {0}'.format(corr_line_t_cc))
    print('E_Line => NT_EC: {0}'.format(corr_line_nt_ec))
    print('E_Line => NO_CC: {0}'.format(corr_line_no_ec))
    print('E_Line => T_EC: {0}'.format(corr_line_t_ec))
    print('E_Line => T_Line: {0}\n'.format(corr_line_t_line))
    ...
    print('{0}:{1} - Spearman correlation:'.format(project, task))
    print('E_Module => NT_CC: {0}'.format(corr_module_nt_cc))
    print('E_Module => NO_CC: {0}'.format(corr_module_no_cc))
    print('E_Module => T_CC: {0}'.format(corr_module_t_cc))
    print('E_Module => NT_EC: {0}'.format(corr_module_nt_ec))
